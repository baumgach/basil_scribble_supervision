...
project_root = '/scratch_net/biwidl102/bmustafa/acdc_segmenter_internal/'
data_root = '/scratch_net/biwidl102/bmustafa/datasets/ACDC/ACDC_challenge_20170617/'
local_hostname = 'biwidl102'  # used to check if on cluster or not
