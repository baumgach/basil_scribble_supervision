...
CUDA_HOME=/scratch_net/biwidl102/software/cuda-8
PROJECT_HOME=/scratch_net/biwidl102/bmustafa/acdc_segmenter_internal
VIRTUAL_ENV_PATH=/scratch_net/biwidl102/bmustafa/python_environments/tensorflow-gpu/
...
#$ -l h_vmem=20G  # Less RAM is required for evaluating than for training
...
#$ -o /scratch_net/biwidl102/bmustafa/acdc_segmenter_internal/logs/acdc/  ## <---------------- CHANGE TO MATCH YOUR SYSTEM
#
...
python $PROJECT_HOME/evaluate_patients.py $1
