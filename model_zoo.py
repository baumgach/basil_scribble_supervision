...
def VGG16_FCN_8(images, training):
    ...
    upscore3 = layers.deconv2D_layer(sum2, name='upscore3', kernel_size=(16,16), strides=(8,8), num_filters=nlabels, weight_init='bilinear')
...
def VGG16_FCN_8_bn(images, training):
    ...
    upscore3 = layers.deconv2D_layer_bn(sum2, name='upscore3', kernel_size=(16,16), strides=(8,8), num_filters=nlabels, weight_init='bilinear', training=training)
...
def unet2D_bn_padding_same(images, training, nlabels):
    ...
    pred = layers.conv2D_layer_bn(conv9_2, 'pred', num_filters=nlabels, kernel_size=(1,1), activation=layers.linear_activation, training=training)
...
def unet2D_bn_crf(images, training, nlabels):
...
def unet3D_bn(images, training, nlabels):
    ...
    pred = layers.conv3D_layer_bn(conv8_2, 'pred', num_filters=nlabels, kernel_size=(1,1,1), activation=layers.linear_activation, training=training, padding='VALID')
