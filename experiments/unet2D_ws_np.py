...
rw_intersection = False         # if true, will random walk to fully segment image based off original scribble
                                # then limit output to the regions defined by the low threshold random walk
rw_reversion = False            # if true, will attempt to revert to original random walked scribbles if the
